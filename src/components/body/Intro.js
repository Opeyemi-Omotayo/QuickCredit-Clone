    ...
    <React.Fragment>
      <div className="flex items-center justify-center px-[3rem] pt-[5rem] font-mono bg-primary">
        <div className="flex flex-col items-center justify-center">
          ...
          <p className="flex flex-col mb-8 text-xs md:text-sm lg:text-lg" >
            <span className="flex items-center justify-center">Apply for up to ₦100,000 with loan tenors</span>
            <span className="flex items-center justify-center">up to 90days and have your money sent</span>
            <span className="flex items-center justify-center">straight to your bank account</span>
            <span className="flex items-center justify-center">in minutes.</span>
          </p>         
            <img
